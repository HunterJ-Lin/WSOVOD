...
def main(args):
    ...
    if "MixedDatasets" in args.config_file:
        from wsovod.engine import DefaultTrainer_WSL_MixedDatasets as Trainer
    else:
...
if __name__ == "__main__":
    ...
    # args.config_file = 'configs/PascalVOC-Detection/WSOVOD_RPN_WSR_18_DC5_1x.yaml'
    # # args.config_file = 'configs/MixedDatasets-Detection/WSOVOD_MRRP_WSR_18_DC5_1x_voc0712+coco.yaml'
    # args.config_file = 'configs/PascalVOC-Detection/WSOVOD_MRRP_WSR_18_DC5_1x.yaml'
    # args.num_gpus = 1
    # # # args.eval_only = True
