...
class SwinTransformer(Backbone):
    ...
    def __init__(self,
        ...
        for i_layer in range(self.num_layers):
            ...
            name = "stage" + str(i_layer+ 2)
            if name in self.out_features:
                self._out_feature_channels[name] = embed_dim * 2 ** i_layer
                self._out_feature_strides[name] = 4 * 2 ** i_layer
...
def build_swin_backbone(cfg, input_shape):
    ...
    return SwinTransformer(
        ...
        patch_norm=cfg.MODEL.SWIN.PATH_NORM,
